...
// lista konta
// ---------------------------------------------------
static function _g_kto( cList )
local GetList:={}

cList := PADR("1310;13101;", 200)

Box(,1,60)
	@ m_x + 1, m_y + 2 SAY "Lista konta:" GET cList PICT "@S40"
	read
BoxC()
...
for i:=1 to LEN( aKto )
  ...
  @ m_x + 1, m_y + 2 SAY "konto: " + cIdKonto
